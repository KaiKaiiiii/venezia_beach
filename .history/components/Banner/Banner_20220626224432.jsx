  ...
  return (
    <section className="w-full h-[500px] relative leading-3">
      ...
      <div className="absolute left-1/2 transform -translate-x-1/2 bottom-0 translate-y-1/2 z-[6] w-full p-[20px]">
        <div className="container p-4 fit-content h-full rounded-2xl blurry flex items-center justify-center shadow-2xl">
...
const Hightlight = ({ percent, title, content, border }) => {
  return (
    <div
      className={`flex flex-col items-center justify-start gap-4 text-center =  w-full h-full `}
    >
      {border ? <div className="bg-thin-border h-[1px] w-full"></div> : ""}
      <h2 className="tracking-wider bg-text-warning text-secondary  bg-clip-text text-fill-transparent font-bold text-2xl ">
        {percent}
      </h2>
