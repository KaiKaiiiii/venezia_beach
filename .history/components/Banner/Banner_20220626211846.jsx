...
const Hightlight = ({ ...props }) => {
  <div className="text-center">
    <h2 className="bg-text-warning font-bold text-2xl">72ha</h2>
    <p className="text-primary text-xl">Quy mô xây dựng</p>
    <p className="text-gray text-xs">5.000m² diện tích xây dựng</p>
  </div>;
};
