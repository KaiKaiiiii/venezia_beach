...
const Hightlight = ({ percent, title, content, ...props }) => {
  return (
    <div className={`text-center ${props} w-full h-full }>
      <h2 className="bg-text-warning text-secondary  bg-clip-text fill-transparent font-bold text-2xl mt-2 leading-3`">
        {percent}
      </h2>
